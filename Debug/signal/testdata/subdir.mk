...
CC_SRCS += \
../signal/testdata/fft_test_data.cc 

CC_DEPS += \
./signal/testdata/fft_test_data.d 

OBJS += \
./signal/testdata/fft_test_data.o 


# Each subdirectory must supply rules for building sources it contributes
signal/testdata/%.o signal/testdata/%.su signal/testdata/%.cyclo: ../signal/testdata/%.cc signal/testdata/subdir.mk
...
clean: clean-signal-2f-testdata

clean-signal-2f-testdata:
	-$(RM) ./signal/testdata/fft_test_data.cyclo ./signal/testdata/fft_test_data.d ./signal/testdata/fft_test_data.o ./signal/testdata/fft_test_data.su

.PHONY: clean-signal-2f-testdata
