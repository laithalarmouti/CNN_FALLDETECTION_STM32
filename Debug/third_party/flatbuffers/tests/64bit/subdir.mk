...
OBJS += \
./third_party/flatbuffers/tests/64bit/offset64_test.o 

CPP_DEPS += \
./third_party/flatbuffers/tests/64bit/offset64_test.d 


# Each subdirectory must supply rules for building sources it contributes
third_party/flatbuffers/tests/64bit/%.o third_party/flatbuffers/tests/64bit/%.su third_party/flatbuffers/tests/64bit/%.cyclo: ../third_party/flatbuffers/tests/64bit/%.cpp third_party/flatbuffers/tests/64bit/subdir.mk
...
clean: clean-third_party-2f-flatbuffers-2f-tests-2f-64bit

clean-third_party-2f-flatbuffers-2f-tests-2f-64bit:
	-$(RM) ./third_party/flatbuffers/tests/64bit/offset64_test.cyclo ./third_party/flatbuffers/tests/64bit/offset64_test.d ./third_party/flatbuffers/tests/64bit/offset64_test.o ./third_party/flatbuffers/tests/64bit/offset64_test.su

.PHONY: clean-third_party-2f-flatbuffers-2f-tests-2f-64bit
