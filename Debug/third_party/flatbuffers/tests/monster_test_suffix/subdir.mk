...
CC_DEPS += \
./third_party/flatbuffers/tests/monster_test_suffix/monster_test.grpc.fb.d 

OBJS += \
./third_party/flatbuffers/tests/monster_test_suffix/monster_test.grpc.fb.o 


# Each subdirectory must supply rules for building sources it contributes
third_party/flatbuffers/tests/monster_test_suffix/%.o third_party/flatbuffers/tests/monster_test_suffix/%.su third_party/flatbuffers/tests/monster_test_suffix/%.cyclo: ../third_party/flatbuffers/tests/monster_test_suffix/%.cc third_party/flatbuffers/tests/monster_test_suffix/subdir.mk
...
clean: clean-third_party-2f-flatbuffers-2f-tests-2f-monster_test_suffix

clean-third_party-2f-flatbuffers-2f-tests-2f-monster_test_suffix:
	-$(RM) ./third_party/flatbuffers/tests/monster_test_suffix/monster_test.grpc.fb.cyclo ./third_party/flatbuffers/tests/monster_test_suffix/monster_test.grpc.fb.d ./third_party/flatbuffers/tests/monster_test_suffix/monster_test.grpc.fb.o ./third_party/flatbuffers/tests/monster_test_suffix/monster_test.grpc.fb.su

.PHONY: clean-third_party-2f-flatbuffers-2f-tests-2f-monster_test_suffix
