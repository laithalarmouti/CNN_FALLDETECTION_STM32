...
OBJS += \
./third_party/flatbuffers/grpc/tests/grpctest.o \
./third_party/flatbuffers/grpc/tests/message_builder_test.o 

CPP_DEPS += \
./third_party/flatbuffers/grpc/tests/grpctest.d \
./third_party/flatbuffers/grpc/tests/message_builder_test.d 


# Each subdirectory must supply rules for building sources it contributes
third_party/flatbuffers/grpc/tests/%.o third_party/flatbuffers/grpc/tests/%.su third_party/flatbuffers/grpc/tests/%.cyclo: ../third_party/flatbuffers/grpc/tests/%.cpp third_party/flatbuffers/grpc/tests/subdir.mk
...
clean: clean-third_party-2f-flatbuffers-2f-grpc-2f-tests

clean-third_party-2f-flatbuffers-2f-grpc-2f-tests:
	-$(RM) ./third_party/flatbuffers/grpc/tests/grpctest.cyclo ./third_party/flatbuffers/grpc/tests/grpctest.d ./third_party/flatbuffers/grpc/tests/grpctest.o ./third_party/flatbuffers/grpc/tests/grpctest.su ./third_party/flatbuffers/grpc/tests/message_builder_test.cyclo ./third_party/flatbuffers/grpc/tests/message_builder_test.d ./third_party/flatbuffers/grpc/tests/message_builder_test.o ./third_party/flatbuffers/grpc/tests/message_builder_test.su

.PHONY: clean-third_party-2f-flatbuffers-2f-grpc-2f-tests
